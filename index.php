...
<div id="menu" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://i.pinimg.com/originals/e2/78/8f/e2788fd28e035281f3bee53c4181d5e0.jpg" class="cr_image"
                 alt="...">
            <div class="carousel-caption d-none d-md-block">
                <blockquote class="blockquote">
                    <p class="mb-5" style="margin-top: -180px; font-size: 30px;">We’ll help you find a place you’ll love.</p>
                </blockquote>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <a href=""  class="btn col-md-12 view-details-button btn-sm">View
                                                        Details
                                                    </a>
                                                </div>
                                            </div>
