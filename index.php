...
<div id="menu" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://i.pinimg.com/originals/3a/6f/c9/3a6fc97e1e9318db4b2f981452eb3451.jpg" class="cr_image" alt="...">
...
<div>
  <h3 style="text-align: left; font-weight: bold; color: #32CD32" class="ml-5 mt-3 mb-4">Most Popular Properties</h3>
</div>
<div class="justify-content-center w-100 ml-4">
...
<div class="footer">
  <div class="row">
    ...
    <div class="col-sm">
      <h6 class="justify-content-center" style=" position: absolute;bottom: 0;">Copyright 2019 All Right Reserved</h6>
    </div>
    <div class="col-sm mt-2">
      <h4 class="text-left">Stay in touch</h4>
      <form>
        <div class="form-group text-left">
          <label for="strn">Subscribe to our newsletter</label>
          <div class="form-group row">
            <div class="col-md-7">
              <input type="email" class="form-control" id="strn" aria-describedby="emailHelp"
                     placeholder="Type your email address">
            </div>
            <div class="col-md-5">
              <button type="submit" class="btn btn-primary mb-2">Subscriber</button>
            </div>
          </div>
        </div>
      </form>
